...
export default function SettingsPage() {
  ...
  return <div className="shell py-8 sm:py-12">
    <Link href="/" className="mb-7 inline-flex items-center gap-2 text-sm font-semibold text-slate-600"><ArrowLeft size={16}/>Back to playlists</Link>
    <div className="mx-auto max-w-2xl">
      ...
      <section className="surface p-5 sm:p-7">
        ...
        <p className="mt-3 text-sm font-medium text-emerald-700" aria-live="polite">Changes are saved automatically.</p>
      </section>
    </div>
  </div>;
}
