...
export default function SettingsPage() {
  ...
  return <div className="shell py-8 sm:py-12">
    <Link href="/" className="mb-7 inline-flex items-center gap-2 text-sm font-semibold text-stone-600"><ArrowLeft size={16}/>Back to playlists</Link>
    <div className="mx-auto max-w-2xl">
      ...
      <section className="surface p-5 sm:p-7">
        <div className="mb-5 flex items-start gap-3"><Languages className="mt-0.5 text-[#EA580C]" size={20}/><div><h2 className="font-bold">Summary language</h2><p className="muted mt-1 text-sm">OpenRouter will generate summaries, key points, and action items in this language.</p></div></div>
        ...
        <p className="mt-3 text-sm font-medium text-[#15803D]" aria-live="polite">Changes are saved automatically.</p>
      </section>
    </div>
  </div>;
}
