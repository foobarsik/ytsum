...
import { ArrowLeft, BookOpen, Captions, ExternalLink, FileText, Loader2, Save, Trash2 } from "lucide-react";
...
export default function VideoPage() {
  ...
  async function readTranscript() {
    if (showTranscriptReader) { setShowTranscriptReader(false); return; }
    if (currentVideo.cleanedTranscript && currentVideo.transcriptEditVersion === 3 && currentVideo.transcriptEditLanguage === summaryLanguage) { setShowTranscriptReader(true); return; }
