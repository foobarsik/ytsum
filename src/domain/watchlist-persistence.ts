...
const transcriptStatusSchema = z.enum(["available", "unavailable", "processing", "failed", "manually_added"]);
...
export const persistedWatchlistChannelSchema: z.ZodType<WatchlistChannel> = z.object({
  ...
  videos: z.array(z.object({
    ...
    insight: z.custom<NonNullable<WatchlistChannel["videos"][number]["insight"]>>(
